/** Inline "Mitthu" parrot logo. Scales to fill its container. */
export default function ParrotMark({ className = '' }) {
  return (
    <svg viewBox="0 0 64 64" className={className} xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <defs>
        <linearGradient id="pmBody" x1="10" y1="12" x2="48" y2="56" gradientUnits="userSpaceOnUse">
          <stop stopColor="#6ee7b7" />
          <stop offset=".55" stopColor="#10b981" />
          <stop offset="1" stopColor="#047857" />
        </linearGradient>
        <linearGradient id="pmBeak" x1="38" y1="24" x2="56" y2="42" gradientUnits="userSpaceOnUse">
      ...
      <ellipse cx="30" cy="34" rx="19" ry="18" fill="url(#pmBody)" />
      <ellipse cx="24" cy="40" rx="8" ry="7" fill="#a7f3d0" opacity=".5" />
      <path d="M43 28c8 0 13 4 12 10-.6 5-6 8-11 6 3-2 4-5 2-7-3 0-5-1-6-4Z" fill="url(#pmBeak)" />
